...
export const ListRequestforuser = () => {
  ...
  const myRequest = async () => {
    ...
    await api.post("my_request", a).then((res) => {
              ...
              <Grid item xs={12} sx={{ minWidth: 300 }}>
                ...
                >
                  <TextField
                    ...
                    fullWidth="true"
                    id="setUser_Comments"
                    label="setUser Comments"
                    name="setUser_Comments"
                    placeholder="setUser Comments"
                    focused
                    type="text"
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <Autocomplete
                    ...
                    id="CPU_Sockets"
                    value={CPU_Sockets}
                    onChange={(e) => setCPU_Sockets(e.target.value)}
                    // onSelect={(e) => handlechange(e)}
                ...
                <Grid item xs={12} sm={6}>
                  <Autocomplete
                    ...
                    onChange={(e) => setStorage_Vendor(e.target.value)}
                    // onSelect={(e) => handlechange(e)}
                ...
                <Grid item xs={12} sm={6}>
                  <Autocomplete
                    ...
                    onChange={(e) => setStorage_Controller(e.target.value)}
                    // onSelect={(e) => handlechange(e)}
                ...
                <Grid item xs={12} sm={6}>
                  <Autocomplete
                    ...
                    id="Network_speed"
                    value={Network_speed}
                    onChange={(e) => setNetwork_speed(e.target.value)}
                    // onSelect={(e) => handlechange(e)}
