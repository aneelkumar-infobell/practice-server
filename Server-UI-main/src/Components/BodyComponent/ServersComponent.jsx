...
const ServersComponent = () => {
  ...
  const platformapi = async () => {
    ...
    setPlatformManufacturer(
      getplatformUrl.data.PlatformProfile.Chassis[0].Manufacturer
    );
    setPlatformIdModel(getplatformUrl.data.PlatformProfile.Chassis[0].Model);
    setPlatformIdPowerState(
      getplatformUrl.data.PlatformProfile.Chassis[0].PowerState
    );
    setPlatformIdHealth(getplatformUrl.data.PlatformProfile.Chassis[0].Health);
    setPlatformSystems(
      getplatformUrl.data.PlatformProfile.Chassis[0].Systems[0]
    );
